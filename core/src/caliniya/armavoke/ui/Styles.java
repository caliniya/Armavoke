...
public class Styles {
  ...
  public static ImageButtonStyle ibuttondef,ibuttonc;
  ...
  public static void load() {
    ...
    ibuttondef.checked = ibuttondef.up;
    
    ibuttonc = new ImageButtonStyle();
    ibuttonc.up = Core.atlas.drawable("button"); // 默认状态
    ibuttonc.down = Core.atlas.drawable("button-1"); // 按下状态
    ibuttonc.checked = ibuttondef.down;
